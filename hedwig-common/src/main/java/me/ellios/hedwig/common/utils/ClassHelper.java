...
public class ClassHelper {
     ...
     * examples, for class path resource loading (but not necessarily for
    ...
    public static String getOuterClassName(Class clazz){
        ...
        int index =  name.indexOf(INNER_CLASS_SPLITTER);
        if(index < 0){
